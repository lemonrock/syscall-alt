...
pub enum Syscall
{
	...
	#[cfg(not(any(target_arch = "mips", target_arch = "arm")))] fadvise64 = SYS_fadvise64,
	...
	#[cfg(not(any(target_arch = "x86", target_arch = "x86_64", target_arch = "arm")))] fstatat = SYS_fstatat,
	fstatfs = SYS_fstatfs,
	fsync = SYS_fsync,
	...
	#[cfg(not(target_arch = "arm"))] getrlimit = SYS_getrlimit,
	...
	#[cfg(not(target_arch = "arm"))] migrate_pages = SYS_migrate_pages,
	mincore = SYS_mincore,
	mkdirat = SYS_mkdirat,
	mknodat = SYS_mknodat,
	mlock = SYS_mlock,
	...
	#[cfg(not(target_arch = "arm"))] mmap = SYS_mmap,
	mount = SYS_mount,
	...
	#[cfg(not(any(target_arch = "x86", target_arch = "x86_64", target_arch = "arm")))] or1k_atomic = SYS_or1k_atomic,
	...
	sync = SYS_sync,
	syncfs = SYS_syncfs,
	#[cfg(not(target_arch = "arm"))] sync_file_range = SYS_sync_file_range,
	sysinfo = SYS_sysinfo,
	syslog = SYS_syslog,
	tee = SYS_tee,
	tgkill = SYS_tgkill,
