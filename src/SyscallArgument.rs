...
// Technically, c_long, but this creates problems because libc defines c_long as either i32 or i64 rather than isize
// See comments in Syscall.rs
pub type SyscallArgument = isize;
