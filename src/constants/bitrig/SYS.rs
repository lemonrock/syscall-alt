...
// Originates from https://github.com/bitrig/bitrig/blob/master/sys/sys/syscall.h (as of commit d6146a8 on 4th March 2016)
...
pub const SYS_sendsyslog: SyscallNumber = 83;
...
pub const SYS_sendsyslog2: SyscallNumber = 112;
