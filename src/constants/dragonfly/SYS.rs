...
// Originate in https://github.com/DragonFlyBSD/DragonFlyBSD/blob/master/sys/kern/syscalls.master
...
pub const SYS_gethostid: SyscallNumber = 142;
pub const SYS_gethostname: SyscallNumber = 87;
pub const SYS_getitimer: SyscallNumber = 86;
pub const SYS_getkerninfo: SyscallNumber = 63;
pub const SYS_getlogin: SyscallNumber = 49;
pub const SYS_getpagesize: SyscallNumber = 64;
pub const SYS_getpeername: SyscallNumber = 141;
...
pub const SYS_killpg: SyscallNumber = 146;
...
pub const SYS_msync: SyscallNumber = 277;
...
pub const SYS_quota: SyscallNumber = 149;
...
pub const SYS_recv: SyscallNumber = 102;
pub const SYS_recvfrom: SyscallNumber = 29;
pub const SYS_recvmsg: SyscallNumber = 113;
...
pub const SYS_send: SyscallNumber = 101;
pub const SYS_sendfile: SyscallNumber = 393;
pub const SYS_sendmsg: SyscallNumber = 114;
...
pub const SYS_sethostid: SyscallNumber = 143;
pub const SYS_sethostname: SyscallNumber = 88;
...
pub const SYS_sigblock: SyscallNumber = 109;
...
pub const SYS_sigsetmask: SyscallNumber = 110;
pub const SYS_sigstack: SyscallNumber = 112;
pub const SYS_sigsuspend: SyscallNumber = 341;
pub const SYS_sigtimedwait: SyscallNumber = 345;
pub const SYS_sigvec: SyscallNumber = 108;
...
pub const SYS_wait: SyscallNumber = 84;
